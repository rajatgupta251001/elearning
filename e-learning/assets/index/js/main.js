...
//	var picker = new Pikaday({ field: document.getElementById('datepicker'), bound: false });
...
function initialize() {
	var mapOptions = {
		zoom: 12,
		center: new google.maps.LatLng(-33.890367, 151.19168),
...
function loadScript() {
	...
	script.src = 'https://maps.googleapis.com/maps/api/js?v=1&sensor=false&' +
			'callback=initMap';
