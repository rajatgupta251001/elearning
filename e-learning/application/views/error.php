...
<div class="content-push">
	...
	<div class="row">
		<div class="col-md-12 information-entry">
			<center><h5 style="font-size: 20em;">404</h5></center>
		</div>
		<div class="col-md-12 information-entry" style="float: right;font-size: 2em;">
			<center>Page not found <br> For more information contact Team E-learning (kiet.elearning@gmail.com)<hr>
				<a href="<?php echo base_url();?>" class="btn btn-lg btn-info">Home</a></center><hr>
