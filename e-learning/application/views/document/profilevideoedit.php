...
<div class="off-canvas-wrapper">
                            ...
                            <div class="large-12 columns">
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        ...
                                        <form data-abide novalidate action="<?php echo base_url();?>index.php/maindocument/finaledit/<?php echo $edit; ?>" method="POST" enctype="multipart/form-data">
 ...
 <div class="large-12 columns">
                                ...
                                <select name="edit_type" >   
                                                            <option><?php echo $vi->type ;?> </option>
                                                            <?php if( $vi->type !=$PPT){?>}
                                                            <option><?php echo $PPT; ?></option>
                                                            <?php }?>
                                                            <?php if( $vi->type !=$EXCEL){?>}
                                                            <option><?php echo $EXCEL; ?></option>
                                                            <?php }?>
                                                            <?php if( $vi->type !=$PDF){?>}
                                                            <option><?php echo $PDF; ?></option>
                                                            <?php }?>
                                                            <?php if( $vi->type !=$WORD){?>}
                                                            <option><?php echo $WORD; ?></option>
                                                            <?php }?>
