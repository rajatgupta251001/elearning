...
<head>
    ...
    <title>E-learning Document</title>
                ...
                <ul class="menu">
                     <li class="dropdown-login">
                       <h6 class="text-center">Welcome:<?php $pdata = $this->session->userdata('logged_in');
                                           ...
                                           {
                                            ?>
                                           <a href="<?php echo base_url();?>index.php/maindocument/upload/BTECH/BIO_TECH/I/WEB" style="align:center"><button>Upload Document</button></a>
                                           <?php } ?>
                                ...
                                <ul class="menu float-right">
                                        ...
                                        <div class="login-form">
                                          ...
                                          <a href="<?php echo base_url();?>index.php/main/changepass" style="align:center"><button>Edit Profile/Change Password</button></a>
                                           ...
                                           {
                                            ?>
                                          <li> <a href="<?php echo base_url();?>index.php/maindocument/upload/BTECH/BIO_TECH/I/WEB" style="align:center"><button>Upload Document</button></a>
                                           <?php } ?></li>
                                ...
                                <div class="widgetBox">
                                    ...
                                    <div class="widgetContent">
                                        <ul class="profile-overview">
                                            ...
                                            <li class="clearfix"><a href="<?php echo base_url();?>index.php/maindocument/profilevideo"><i class="fa fa-pencil"></i>Document <span class="float-right"><?php  echo $admin[0]->upload;?></span></a></li>
                                            
                                           
                                            <li class="clearfix"><a href="<?php echo base_url();?>index.php/main/logout"><i class="fa fa-sign-out"></i>Logout</a></li>
                                        </ul>

                                        <a href="<?php echo base_url();?>index.php/maindocument/upload/BTECH/BIO_TECH/I/WEB" class="button"><i class="fa fa-plus-circle"></i>Submit Document</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="media-object stack-for-small">
                                        ...
                                        <div class="media-object-section media-video-content">
                                            <div class="video-content">
                                                ...
                                                <p><?php echo $vide->type;?></p>
                                                <p><br>&nbsp;<?php for($i=0;$i<110;$i++)echo "&nbsp;"; ?>(<?php echo $vide->course;?>/<?php echo $vide->branch;?>/<?php echo $vide->semester;?>/<?php echo $vide->subject;?>)</p>
                                            </div>
                                            <div class="video-detail clearfix">
                                                ...
                                                <div class="video-btns">
                                                    ...
                                                    <a class="video-btn" href="<?php echo base_url();?>index.php/maindocument/single/<?php echo $vide->sno;?>"><i class="fa fa-pencil"></i>Read</a>
                                                    <a class="video-btn" href="<?php echo base_url();?>index.php/maindocument/profilevideoedit/<?php echo $vide->sno;?>"><i class="fa fa-pencil-square-o"></i>edit</a>
<a class="video-btn" href="<?php echo base_url();?>index.php/maindocument/delete/<?php echo $vide->sno;?>/<?php if($vide->active =='YES')echo "NO";else echo "YES";?>"><i class="fa fa-trash"></i>
                                                        <?php
                                                    if($vide->active =='YES')
                                                        echo "delete";
                                                    else
                                    ...
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                           <img src="<?php echo base_url(); ?>assets/dashboardvideo/images/<?php echo $image->link; ?>" alt="E-learning">
                                            <a href="<?php echo base_url();?>index.php/maindocument/single/<?php echo $activ->sno;?>" class="hover-posts">
