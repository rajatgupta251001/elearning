			...
			<div class="information-blocks">
				...
				<div class="row">
					<div class="col-md-6 information-entry">
						...
						<p style="font-size: 1em;">Document</p>
				...
				<div class="class=col-md-12 information-entry" style="margin: 2em;">
					...
					<button class="button style-3" type="submit">Document Search</button>
		...
		# code...
									...
									<li>
										...
										<a href="<?php echo base_url();?>index.php/maindocument/single/<?php echo $kkk->sno;?>" style="color: #ca1515;font-size: 2em;font-family: 'Francois One', sans-serif;"><b style="color: #ca1515">[<?php echo $kkk->type;?>]</b><?php echo $kkk->title;?><b>(<?php echo $uploadname;?>)</b></a>
