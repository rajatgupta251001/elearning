...
<div class="content-push">
	...
	<div class="row">
		<div class="col-md-12 information-entry">
			<center><h5 style="font-size: 4em;">Thank You For Registration.</h5></center>
		</div>
		<div class="col-md-12 information-entry" style="float: right;font-size: 1.5em;">
			<center>For login Details <br>Please check your KIET E-mail Id<hr>
				<a href="<?php echo base_url();?>" class="btn btn-lg btn-info">Log In</a></center><hr>
