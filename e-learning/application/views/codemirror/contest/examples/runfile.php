...
<head>
 ...
 <!-- js Composer CSS -->
    ...
    <body class="single single-portfolio postid-684 hero- header-boxed header-margin-true header-trans-false header-is-closing-true desktop wpb-js-composer js-comp-ver-4.7 vc_responsive portfolio-category-art-direction portfolio-category-brand-development portfolio-tag-fashion" style="overflow: scroll !important;"> 
        ...
        <div id="page" class="site">
            <div id="content" class="site-content">
                <div class="single-item portfolio-fullscreen">
...
<article>
<form form action="<?php echo base_url();?>index.php/main/contestquestion1/<?php echo $id;?>" method="POST" enctype="multipart/form-data">
...
<br><b>Output</b>
<b>
<textarea rows="4" ><?php if($response['compile_status']=="OK"){ 

    if (trim($response['run_status']['output']) == $output) {
        # code...
echo "Accepted\n" ;
$session_data = array('outputresult' =>"Accepted");
// Add user data in session
$this->session->set_userdata('code', $session_data);
...
$session_data = array('outputresult' =>"Wrong");
// Add user data in session
$this->session->set_userdata('code', $session_data);
    }
...
echo ".................................................\n";
?>
Time:<?php echo $response['run_status']['time_used'];echo "       ";?>Memory:<?php echo $response['run_status']['memory_used'];echo "";
}
else 
{
    echo $response['compile_status'];

$session_data = array('outputresult' =>"Error");
// Add user data in session
$this->session->set_userdata('code', $session_data);
}
...
<textarea id="code" name="code" ><?php echo $code;?>
</textarea>
...
<br>
<div class="popup" onclick="myFunction()" class="vc_col-sm-12" style="left:10%;"><p style="z-index: 100;font-size: 30px;color: grey;">Submissions</p>
  <div class="popuptext" id="myPopup">
  <table style="border: 1px solid black;">
  <tr style="background-color: grey;"><th>Source</th>
  <th>Name</th>
<th>Status</th>
  </tr>
...
<?php
$pp=1;
foreach ($contestcode as $contestcod) {
    # code...
    if ($contestcod->type=="file") {
        # code...?>
        <tr><th>file</th>
        <th><a href="<?php echo base_url();?>application/views/codemirror/contest/examples/<?php echo $contestcod->code;?>" terget="_blank" download><?php echo $contestcod->code;?></a></th>
        <th><?php echo $contestcod->status;?></th></tr>
        <?php
    }
     if ($contestcod->type=="source") {
        # code...?>
        <tr><th>code</th>
        <th><a href="#" onclick="aa(fileName, '<?php echo 'codedevil';?><?php echo $pp;?>','text/html')">code<?php echo $pp;?></a>
        <div hidden="" id="codedevil<?php echo $pp;?>"><?php echo $contestcod->code;?></div></th>
        <th><?php echo $contestcod->status;$pp++;?></th></tr>
        <?php
    }
}
?>
...
<script type="text/javascript">
    function aa(filename, elId, mimeType) {
...
var fileName =  'code.txt'; // You can use the .txt extension if you want
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> 
                     ...
                     <div class="project-trigger"> <i class="fa fa-expand" style="background-color: grey;"></i>
                    
                        <div class="wrapper" >
                            <h2>Problem <?php echo $id; ?></h2>
                            <div class="project-content">
                                <p style="overflow: scroll;height: 300px;   "><?php
                                foreach($contest as $contes)
                                 echo $contes->problem;?></p>
 ...
 <footer id="colophon" class="site-footer" role="contentinfo">
        ...
        <script type='text/javascript' src='<?php echo base_url(); ?>assets/codemirror/js/slimScroll.min.js'></script>
        <script type='text/javascript' src='<?php echo base_url(); ?>assets/codemirror/js/jquery.fullpage.min.js'></script>
        <style type="text/css">
            body
            {
