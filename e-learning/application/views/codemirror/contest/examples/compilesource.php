...
$hackerearth = Array(
        ...
        'time_limit' => '3',   //(OPTIONAL) Time Limit (MAX = 5 seconds )
        'memory_limit' => '262144'  //(OPTIONAL) Memory Limit (MAX = 262144 [256 MB])
	);

//Feeding Data Into Hackerearth API
$config = Array();
$config['time']='3';	 	//(OPTIONAL) Your time limit in integer and in unit seconds
...
<br><b>Output</b>
<b>
<textarea rows="4" ><?php echo $response['compile_status'];?>
</textarea></b>
