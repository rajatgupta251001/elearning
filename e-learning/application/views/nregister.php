...
<div class="content-push">
	...
	<div class="row">
		<div class="col-md-12 information-entry">
			<center><h5 style="font-size: 4em;">You Have Not Registered.</h5></center>
		</div>
		<div class="col-md-12 information-entry" style="float: right;font-size: 1.5em;">
			<center><br>For more information contact Team E-learning (kiet.elearning@gmail.com)<hr>
				<a href="<?php echo base_url();?>index.php/main/signup" class="btn btn-lg btn-info">Sign Up</a></center><hr>
